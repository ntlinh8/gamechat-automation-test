...
Wait Until Page Source Contain "${text}"
    Wait Until Keyword Succeeds    10x    1x    Page Source Should Contain   ${text}
    
Wait "${time}" Until Page Source Contain "${text}"
    Wait Until Keyword Succeeds    ${time}    3s    Page Source Should Contain   ${text}
    
Wait Until Page Source Not Contain "${text}"
    Wait Until Keyword Succeeds    10x    1x    Page Source Should Not Contain   ${text}
